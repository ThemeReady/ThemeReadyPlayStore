.class public final Landroid/support/v7/widget/du;
...
.field public p:Landroid/support/v7/widget/ds;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 6
    iput v3, p0, Landroid/support/v7/widget/du;->n:I

    .line 7
    iput v4, p0, Landroid/support/v7/widget/du;->o:I
    ...
    .line 8
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/du;->n:I

    .line 9
    iput v3, p0, Landroid/support/v7/widget/du;->o:I
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 28
    iget-object v0, p0, Landroid/support/v7/widget/du;->p:Landroid/support/v7/widget/ds;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/n;->getCount()I
    ...
    .line 43
    invoke-virtual {v1, v0}, Landroid/support/v7/view/menu/n;->getItem(I)Ljava/lang/Object;
    ...
    .line 44
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/du;->q:Landroid/view/MenuItem;

    .line 45
    if-eq v2, v0, :cond_1

    .line 47
    iget-object v1, v1, Landroid/support/v7/view/menu/n;->b:Landroid/support/v7/view/menu/o;

    .line 49
    if-eqz v2, :cond_0

    .line 50
    iget-object v3, p0, Landroid/support/v7/widget/du;->p:Landroid/support/v7/widget/ds;

    invoke-interface {v3, v1, v2}, Landroid/support/v7/widget/ds;->a(Landroid/support/v7/view/menu/o;Landroid/view/MenuItem;)V

    .line 51
    :cond_0
    iput-object v0, p0, Landroid/support/v7/widget/du;->q:Landroid/view/MenuItem;

    .line 52
    if-eqz v0, :cond_1

    .line 53
    iget-object v2, p0, Landroid/support/v7/widget/du;->p:Landroid/support/v7/widget/ds;

    invoke-interface {v2, v1, v0}, Landroid/support/v7/widget/ds;->b(Landroid/support/v7/view/menu/o;Landroid/view/MenuItem;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/du;->n:I
    ...
    iget v0, p0, Landroid/support/v7/widget/du;->o:I
...
.method public final setHoverListener(Landroid/support/v7/widget/ds;)V
    .locals 0

    .prologue
    .line 11
    iput-object p1, p0, Landroid/support/v7/widget/du;->p:Landroid/support/v7/widget/ds;
