...
.method public final a(Landroid/support/v7/widget/fk;)V
    ...
    .line 4
    iget-object v2, p1, Landroid/support/v7/widget/fk;->h:Landroid/support/v7/widget/fk;

    if-eqz v2, :cond_0

    iget-object v2, p1, Landroid/support/v7/widget/fk;->i:Landroid/support/v7/widget/fk;

    if-nez v2, :cond_0

    .line 5
    iput-object v3, p1, Landroid/support/v7/widget/fk;->h:Landroid/support/v7/widget/fk;

    .line 6
    :cond_0
    iput-object v3, p1, Landroid/support/v7/widget/fk;->i:Landroid/support/v7/widget/fk;

    .line 8
    iget v2, p1, Landroid/support/v7/widget/fk;->j:I
    ...
    .line 10
    iget-object v3, p0, Landroid/support/v7/widget/eo;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 26
    iget-object v5, v3, Landroid/support/v7/widget/RecyclerView;->k:Landroid/support/v7/widget/fa;

    invoke-virtual {v5, v4}, Landroid/support/v7/widget/fa;->b(Landroid/support/v7/widget/fk;)V

    .line 27
    iget-object v5, v3, Landroid/support/v7/widget/RecyclerView;->k:Landroid/support/v7/widget/fa;

    invoke-virtual {v5, v4}, Landroid/support/v7/widget/fa;->a(Landroid/support/v7/widget/fk;)V
