...
.method private final c(Landroid/support/v7/widget/ah;)V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/eq;->a()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/eq;->c()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/eq;->d()V
...
# virtual methods
.method public final a(I)Landroid/support/v7/widget/fk;
    .locals 7
    ...
    .line 3
    iget-object v0, v4, Landroid/support/v7/widget/RecyclerView;->n:Landroid/support/v7/widget/bo;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/bo;->c(I)Landroid/view/View;
    ...
    .line 8
    iget v6, v0, Landroid/support/v7/widget/fk;->c:I

    if-ne v6, p1, :cond_4

    .line 9
    iget-object v1, v4, Landroid/support/v7/widget/RecyclerView;->n:Landroid/support/v7/widget/bo;

    iget-object v6, v0, Landroid/support/v7/widget/fk;->a:Landroid/view/View;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v7/widget/bo;->d(Landroid/view/View;)Z
...
.method public final a(II)V
    ...
    iget v1, v0, Landroid/support/v7/widget/fh;->d:I

    add-int/2addr v1, p2

    iput v1, v0, Landroid/support/v7/widget/fh;->d:I
...
.method public final a(IILjava/lang/Object;)V
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/fk;->b()Z
    ...
    .line 34
    iget v6, v5, Landroid/support/v7/widget/fk;->c:I
    ...
    .line 35
    invoke-virtual {v5, v8}, Landroid/support/v7/widget/fk;->b(I)V

    .line 36
    invoke-virtual {v5, p3}, Landroid/support/v7/widget/fk;->a(Ljava/lang/Object;)V
    ...
    iput-boolean v7, v0, Landroid/support/v7/widget/eu;->e:Z
    ...
    .line 47
    invoke-virtual {v0, v8}, Landroid/support/v7/widget/fk;->b(I)V
...
.method public final a(Landroid/support/v7/widget/ah;)V
    ...
    .prologue
    .line 52
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ef;->c(Landroid/support/v7/widget/ah;)V
...
.method public final c(II)V
    ...
    iget v5, v4, Landroid/support/v7/widget/fk;->c:I

    if-lt v5, p1, :cond_0

    .line 70
    invoke-virtual {v4, p2, v0}, Landroid/support/v7/widget/fk;->a(IZ)V

    .line 71
    iget-object v4, v2, Landroid/support/v7/widget/RecyclerView;->am:Landroid/support/v7/widget/fh;

    iput-boolean v6, v4, Landroid/support/v7/widget/fh;->g:Z
    ...
    .line 73
    :cond_1
    iget-object v3, v2, Landroid/support/v7/widget/RecyclerView;->k:Landroid/support/v7/widget/fa;

    .line 74
    iget-object v1, v3, Landroid/support/v7/widget/fa;->c:Ljava/util/ArrayList;
    ...
    iget v5, v0, Landroid/support/v7/widget/fk;->c:I

    if-lt v5, p1, :cond_2

    .line 78
    invoke-virtual {v0, p2, v6}, Landroid/support/v7/widget/fk;->a(IZ)V
...
.method public final d(II)V
    ...
    .line 83
    iget-object v7, p0, Landroid/support/v7/widget/ef;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-static {v9}, Landroid/support/v7/widget/RecyclerView;->c(Landroid/view/View;)Landroid/support/v7/widget/fk;
    ...
    iget v10, v9, Landroid/support/v7/widget/fk;->c:I
    ...
    invoke-virtual {v9, v10, v6}, Landroid/support/v7/widget/fk;->a(IZ)V

    .line 98
    :goto_2
    iget-object v9, v7, Landroid/support/v7/widget/RecyclerView;->am:Landroid/support/v7/widget/fh;

    iput-boolean v2, v9, Landroid/support/v7/widget/fh;->g:Z
    ...
    .line 97
    :cond_2
    invoke-virtual {v9, v0, v6}, Landroid/support/v7/widget/fk;->a(IZ)V

    goto :goto_2

    .line 100
    :cond_3
    iget-object v8, v7, Landroid/support/v7/widget/RecyclerView;->k:Landroid/support/v7/widget/fa;
    ...
    .line 108
    :goto_3
    iget-object v0, v8, Landroid/support/v7/widget/fa;->c:Ljava/util/ArrayList;
    ...
    iget v10, v0, Landroid/support/v7/widget/fk;->c:I
    ...
    invoke-virtual {v0, v10, v6}, Landroid/support/v7/widget/fk;->a(IZ)V
    ...
    .line 114
    :cond_6
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/fk;->a(IZ)V
