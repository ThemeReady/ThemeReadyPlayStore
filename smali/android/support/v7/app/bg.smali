...
# instance fields
.field public f:Landroid/support/v7/app/ae;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 8
    invoke-direct {p0}, Landroid/support/v7/app/bg;->b()Landroid/support/v7/app/ae;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v7/app/ae;->a(Landroid/os/Bundle;)V
...
.method private final b()Landroid/support/v7/app/ae;
    .locals 2

    .prologue
    .line 36
    iget-object v0, p0, Landroid/support/v7/app/bg;->f:Landroid/support/v7/app/ae;
    ...
    invoke-static {v0, v1, p0}, Landroid/support/v7/app/ae;->a(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/ad;)Landroid/support/v7/app/ae;

    move-result-object v0

    .line 39
    iput-object v0, p0, Landroid/support/v7/app/bg;->f:Landroid/support/v7/app/ae;
...
.method public final a()Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/ae;->c(I)Z
...
.method public setTitle(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/bg;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/ae;->a(Ljava/lang/CharSequence;)V
