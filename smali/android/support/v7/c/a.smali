...
.field public final d:[Landroid/support/v7/c/h;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v7/c/b;-><init>()V

    sput-object v0, Landroid/support/v7/c/a;->f:Ljava/util/Comparator;

    return-void
.end method

.method constructor <init>([II[Landroid/support/v7/c/h;)V
    .locals 9
    ...
    iput-object v0, p0, Landroid/support/v7/c/a;->e:[F

    .line 3
    iput-object p3, p0, Landroid/support/v7/c/a;->d:[Landroid/support/v7/c/h;
    ...
    .line 19
    iget-object v4, p0, Landroid/support/v7/c/a;->e:[F

    invoke-static {v3, v4}, Landroid/support/v4/c/a;->a(I[F)V

    .line 20
    iget-object v3, p0, Landroid/support/v7/c/a;->e:[F
    ...
    invoke-direct {v4, v7, v2}, Landroid/support/v7/c/j;-><init>(II)V
    ...
    sget-object v2, Landroid/support/v7/c/a;->f:Ljava/util/Comparator;

    invoke-direct {v0, p2, v2}, Ljava/util/PriorityQueue;-><init>(ILjava/util/Comparator;)V

    .line 39
    new-instance v2, Landroid/support/v7/c/c;
    ...
    invoke-direct {v2, p0, v1, v3}, Landroid/support/v7/c/c;-><init>(Landroid/support/v7/c/a;II)V
...
.method private final a(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 61
    invoke-virtual {v0}, Landroid/support/v7/c/c;->e()Landroid/support/v7/c/j;

    move-result-object v0

    .line 63
    invoke-virtual {v0}, Landroid/support/v7/c/j;->a()[F
...
.method private static a(Ljava/util/PriorityQueue;I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/c/c;->b()Z
    ...
    .line 50
    :cond_0
    invoke-virtual {v0}, Landroid/support/v7/c/c;->d()I
    ...
    iget-object v3, v0, Landroid/support/v7/c/c;->j:Landroid/support/v7/c/a;

    add-int/lit8 v4, v1, 0x1

    iget v5, v0, Landroid/support/v7/c/c;->b:I

    invoke-direct {v2, v3, v4, v5}, Landroid/support/v7/c/c;-><init>(Landroid/support/v7/c/a;II)V

    .line 52
    iput v1, v0, Landroid/support/v7/c/c;->b:I

    .line 53
    invoke-virtual {v0}, Landroid/support/v7/c/c;->c()V
...
.method private final a([F)Z
    ...
    .line 92
    iget-object v1, p0, Landroid/support/v7/c/a;->d:[Landroid/support/v7/c/h;
    ...
    .line 94
    iget-object v3, p0, Landroid/support/v7/c/a;->d:[Landroid/support/v7/c/h;

    aget-object v3, v3, v1

    invoke-interface {v3, p1}, Landroid/support/v7/c/h;->a([F)Z
