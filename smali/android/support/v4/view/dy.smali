...
.method public a(Landroid/view/ViewParent;Landroid/view/View;)V
    ...
    invoke-interface {p1, p2}, Landroid/support/v4/view/bg;->onStopNestedScroll(Landroid/view/View;)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;IIII)V
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v4/view/bg;->onNestedScroll(Landroid/view/View;IIII)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;II[I)V
    ...
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/bg;->onNestedPreScroll(Landroid/view/View;II[I)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FF)Z
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/bg;->onNestedPreFling(Landroid/view/View;FF)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
    ...
    invoke-interface {p1, p2, p3, p4, p5}, Landroid/support/v4/view/bg;->onNestedFling(Landroid/view/View;FFZ)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/bg;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
...
.method public b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-interface {p1, p2, p3, p4}, Landroid/support/v4/view/bg;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
