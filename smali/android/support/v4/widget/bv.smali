...
.method public a(Landroid/widget/TextView;)I
    ...
    .line 8
    .line 9
    sget-boolean v0, Landroid/support/v4/widget/ca;->d:Z
    ...
    invoke-static {v0}, Landroid/support/v4/widget/ca;->a(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v0

    sput-object v0, Landroid/support/v4/widget/ca;->c:Ljava/lang/reflect/Field;

    .line 11
    sput-boolean v1, Landroid/support/v4/widget/ca;->d:Z

    .line 12
    :cond_0
    sget-object v0, Landroid/support/v4/widget/ca;->c:Ljava/lang/reflect/Field;

    if-eqz v0, :cond_2

    sget-object v0, Landroid/support/v4/widget/ca;->c:Ljava/lang/reflect/Field;

    invoke-static {v0, p1}, Landroid/support/v4/widget/ca;->a(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I
    ...
    .line 13
    sget-boolean v0, Landroid/support/v4/widget/ca;->b:Z
    ...
    sput-object v0, Landroid/support/v4/widget/ca;->a:Ljava/lang/reflect/Field;

    .line 15
    sput-boolean v1, Landroid/support/v4/widget/ca;->b:Z

    .line 16
    :cond_1
    sget-object v0, Landroid/support/v4/widget/ca;->a:Ljava/lang/reflect/Field;
