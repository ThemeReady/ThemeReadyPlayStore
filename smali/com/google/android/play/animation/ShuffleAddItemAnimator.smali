...
.method private animateAddImpl(Landroid/support/v7/widget/fk;)V
    .locals 3
    ...
    .line 64
    new-instance v2, Lcom/google/android/play/animation/g;

    invoke-direct {v2, p0, v1, p1, v0}, Lcom/google/android/play/animation/g;-><init>(Lcom/google/android/play/animation/ShuffleAddItemAnimator;Landroid/view/View;Landroid/support/v7/widget/fk;Landroid/view/ViewPropertyAnimator;)V
...
.method public animateAdd(Landroid/support/v7/widget/fk;)Z
    ...
    .line 52
    invoke-virtual {p0, p1}, Lcom/google/android/play/animation/ShuffleAddItemAnimator;->shouldAnimateAsShuffle(Landroid/support/v7/widget/fk;)Z
...
.method public animateChange(Landroid/support/v7/widget/fk;Landroid/support/v7/widget/fk;IIII)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/gl;->dispatchChangeFinished(Landroid/support/v7/widget/fk;Z)V
    ...
    :cond_2
    invoke-super/range {p0 .. p6}, Landroid/support/v7/widget/bu;->animateChange(Landroid/support/v7/widget/fk;Landroid/support/v7/widget/fk;IIII)Z
...
.method protected createShuffleAnimation(Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/ViewPropertyAnimator;
    ...
    .line 67
    .line 68
    sget-boolean v0, Lcom/google/android/play/animation/i;->a:Z
    ...
    .line 71
    sget-object v1, Lcom/google/android/play/animation/i;->b:[I

    invoke-virtual {p1, v1}, Landroid/view/View;->getLocationInWindow([I)V

    .line 72
    sget-object v1, Lcom/google/android/play/animation/i;->c:[I
    ...
    sget-object v2, Lcom/google/android/play/animation/i;->c:[I
    ...
    .line 74
    sget-object v2, Lcom/google/android/play/animation/i;->b:[I

    aget v2, v2, v4

    sget-object v3, Lcom/google/android/play/animation/i;->c:[I
...
.method public endAnimation(Landroid/support/v7/widget/fk;)V
    ...
    .prologue
    .line 93
    invoke-super {p0, p1}, Landroid/support/v7/widget/bu;->endAnimation(Landroid/support/v7/widget/fk;)V
...
.method public runPendingAnimations()V
    ...
    .line 34
    invoke-super {p0, v1}, Landroid/support/v7/widget/bu;->animateAdd(Landroid/support/v7/widget/fk;)Z
    ...
    check-cast v2, Landroid/support/v7/widget/fk;

    .line 44
    invoke-direct {p0, v2}, Lcom/google/android/play/animation/ShuffleAddItemAnimator;->animateAddImpl(Landroid/support/v7/widget/fk;)V
...
.method protected shouldAnimateAsShuffle(Landroid/support/v7/widget/fk;)Z
    .locals 1

    .prologue
    .line 90
    instance-of v0, p1, Lcom/google/android/play/animation/h;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/google/android/play/animation/h;

    .line 91
    invoke-interface {p1}, Lcom/google/android/play/animation/h;->a()Z
